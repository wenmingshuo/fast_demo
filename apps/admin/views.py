...
class OeOpenAccountServer:
    ...
    @AdminRouter.get('/dev_op_3', description='434134123')
    async def dev_op_3(self):
        await asyncio.sleep(1000)
        return JSONResponse({"code": 0})

    @AdminRouter.get('/dev_op_4', description='43213213')
    async def dev_op_4(self):
        await asyncio.sleep(1000)
        return JSONResponse({"code": 0})

    @AdminRouter.get('/dev_op_5', description='43213213')
    async def dev_op_5(self):
        await asyncio.sleep(1000)
        return JSONResponse({"code": 0})

    @AdminRouter.get('/dev_op_6', description='43213213')
